...
import { ensureLegacyProductCredentialInventory, ensureOrderCredentialsTable } from '@/lib/credentials-inventory';
...
async function handlePaymentCompleted(
    ...
    await ensureLegacyProductCredentialInventory(sql, Number(order.product_id))
