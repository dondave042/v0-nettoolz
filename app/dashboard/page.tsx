...
import { PaymentMethodManager } from "@/components/dashboard/payment-method-manager"
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 overflow-auto">
          <div className="mx-auto max-w-6xl px-4 py-8 lg:px-8">
            ...
            <div className="mt-8">
              <h2 className="text-xl font-bold text-foreground mb-4">Payment Management</h2>
              <div className="space-y-6">
                <PaymentMethodManager />
                <PaymentHistoryView limit={10} />
              </div>
            </div>
          </div>
